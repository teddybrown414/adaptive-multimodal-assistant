...
async def process_img(file: cl.File, user_message: str) -> str:
    ...
    """
    await cl.Message(content=f"🖼️ Processing your image file '{file.name}'... Please hold on while I work on it! It will take some minutes.").send()
    ...
    llm = ChatOllama(model="llava-llama3", base_url=base_url)
